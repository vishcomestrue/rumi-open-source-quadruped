                ...
                if not _rec_active:
                    ...
                    if n > 0:
                        ...
                        np.savez(
                            ...
                            signal_mode        = np.array([sig.mode]),
                            hip_centre_deg     = np.array([float(sl_hip_amp.value)]),
                            thigh_centre_deg   = np.array([float(sl_thigh_amp.value)]),
                            calf_centre_deg    = np.array([float(sl_calf_amp.value)]),
                            hip_swing_deg      = np.array([float(sl_hip_swing.value)]),
                            thigh_swing_deg    = np.array([float(sl_thigh_swing.value)]),
                            calf_swing_deg     = np.array([float(sl_calf_swing.value)]),
                            frequency_hz       = np.array([float(sl_freq.value)]),
                            step_period_s      = np.array([float(sl_step_T.value)]),
                            chirp_f1_hz        = np.array([float(sl_chirp_f1.value)]),
                            chirp_sweep_s      = np.array([float(sl_chirp_t.value)]),
                            standup_duration_s = np.array([float(sl_standup_dur.value)]),
                        )
